...
`.wander <radius>` - make bots walk freely and continuously within the specified radius (in blocks) from their current position. While wandering, bots also perform swing attacks, interact actions, use items, and occasionally send random commands to increase packet activity.  
